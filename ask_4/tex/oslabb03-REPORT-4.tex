...
\lstset{emph={PID, NMSG, delay, id},emphstyle=\color{blue}}
\lstset{emph={SIREN},emphstyle=\color{yellow}}
\lstset{emph={DIE, DEAD, STOP},emphstyle=\color{red}}
\lstset{emph={NEXT, NEEEEEEEEEEXT},emphstyle=\color{ForestGreen}}
